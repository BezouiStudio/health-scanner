      ...
      <Card className="w-full max-w-lg shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-md text-muted-foreground pt-2">
            Enter the product&apos;s barcode number below to fetch its details and health/safety score.
            This works for food and cosmetic products. Actual camera scanning is not implemented in this version.
          </CardDescription>
        </CardHeader>
